const CACHE = 'io-notes-shell-v27';
const ASSETS = ['/', '/index.html', '/app.css?v=27', '/app.js?v=27', '/manifest.webmanifest?v=27', '/icon-note-192.png', '/icon-note-512.png', '/icon-note-maskable-512.png', '/favicon-io-notes.png'];
