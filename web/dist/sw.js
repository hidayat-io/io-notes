const CACHE = 'io-notes-shell-v22';
const ASSETS = ['/', '/index.html', '/app.css?v=22', '/app.js?v=22', '/manifest.webmanifest?v=22', '/icon-note-192.png', '/icon-note-512.png', '/icon-note-maskable-512.png', '/favicon-io-notes.png'];
